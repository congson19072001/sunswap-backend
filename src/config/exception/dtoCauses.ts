export class DtoCauses {
    ...
    public static TOKEN_ONCHAIN_NAME_STRING = {
        message: "Token name must be string",
        error_code: "TOKEN_ONCHAIN_NAME_STRING",
    }

    public static TOKEN_STATUS_ACTIVE_INACTIVE = {
        message: "Status must be active or inactive",
        error_code: "TOKEN_STATUS_ACTIVE_INACTIVE",
    }

    public static TOKEN_ONCHAIN_NAME_MAX_LENGTH = {
        message: "Token name must not be longer than 255 characters",
    ...
    public static TOKEN_COMPANY_MAX_LENGTH = {
        message: "Company name must not be longer than 255 characters",
    ...
    public static TOKEN_SYMBOL_MAX_LENGTH = {
        message: "Symbol must not be longer than 255 characters",
        error_code: "TOKEN_SYMBOL_MAX_LENGTH",
    }

    public static CHAIN_ID_STRING = {
        message: "Chain ID must be string",
        error_code: "CHAIN_ID_STRING",
    }

    public static TOKEN_ADDRESS_STRING = {
        message: "Token address must be string",
        error_code: "TOKEN_ADDRESS_STRING",
    }

    public static TOKEN_ADDRESS_MAX_LENGTH = {
        message: "Token address must not be longer than 255 characters",
        error_code: "TOKEN_ADDRESS_MAX_LENGTH",
    }

    public static TOKEN_API_GET_BALANCE_STRING = {
        message: "Token API get balance must be string",
        error_code: "TOKEN_API_GET_BALANCE_STRING",
    }

    public static TOKEN_API_GET_BALANCE_MAX_LENGTH = {
        message: "Token API get balance must not be longer than 512 characters",
        error_code: "TOKEN_API_GET_BALANCE_MAX_LENGTH",
    }

    public static TOKEN_API_INCREASE_BALANCE_STRING = {
        message: "Token API increase balance must be string",
        error_code: "TOKEN_API_INCREASE_BALANCE_STRING",
    }

    public static TOKEN_API_INCREASE_BALANCE_MAX_LENGTH = {
        message: "Token API increase balance must not be longer than 512 characters",
        error_code: "TOKEN_API_INCREASE_BALANCE_MAX_LENGTH",
    }

    public static TOKEN_API_VERIFY_REQUEST_STRING = {
        message: "Token API verify request must be string",
        error_code: "TOKEN_API_VERIFY_REQUEST_STRING",
    }

    public static TOKEN_API_VERIFY_REQUEST_MAX_LENGTH = {
        message: "Token API verify request must not be longer than 512 characters",
    ...
    public static TOKEN_API_KEY_STRING = {
        message: "Token API key must be string",
        error_code: "TOKEN_API_KEY_STRING",
    }

    public static TOKEN_API_VERSION_NOT_EMPTY = {
        message: "Token API version must not be empty",
        error_code: "TOKEN_API_VERSION_NOT_EMPTY",
    }

    public static TOKEN_API_VERSION_STRING = {
        message: "Token API version must be string",
        error_code: "TOKEN_API_VERSION_STRING",
    }
    ...
    public static WALLET_MIN_LENGTH = {
        message: "Wallet is too short, at least 6 characters",
        error_code: "WALLET_MIN_LENGTH",
    }

    public static WALLET_MAX_LENGTH = {
        message: "Wallet is too long, no longer then 100 characters",
    ...
    public static REFRESH_TOKEN_EMPTY = {
