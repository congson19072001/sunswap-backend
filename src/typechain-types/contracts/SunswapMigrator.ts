...
export interface SunswapMigratorInterface extends utils.Interface {
  functions: {
...
export interface SunswapMigrator extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SunswapMigratorInterface;
