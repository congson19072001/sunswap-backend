...
export interface SunswapRouter01Interface extends utils.Interface {
  functions: {
...
export interface SunswapRouter01 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SunswapRouter01Interface;
