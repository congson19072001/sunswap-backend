...
export interface SunswapRouter02Interface extends utils.Interface {
  functions: {
...
export interface SunswapRouter02 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SunswapRouter02Interface;
