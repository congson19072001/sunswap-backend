...
export interface ISunSwapFactoryInterface extends utils.Interface {
  functions: {
...
export interface ISunSwapFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ISunSwapFactoryInterface;
