...
export interface ISunswapMigratorInterface extends utils.Interface {
  functions: {
...
export interface ISunswapMigrator extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ISunswapMigratorInterface;
