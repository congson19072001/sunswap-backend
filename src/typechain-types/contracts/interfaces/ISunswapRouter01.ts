...
export interface ISunswapRouter01Interface extends utils.Interface {
  functions: {
...
export interface ISunswapRouter01 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ISunswapRouter01Interface;
